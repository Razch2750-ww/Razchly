    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="relative w-full max-w-2xl bg-app-card border border-app-border rounded-3xl p-6 my-8 overflow-hidden text-app-text"
          role="dialog"
          aria-modal="true"
          aria-labelledby="interest-overview-title"
        >
          {/* Header */}
          <div className="flex items-center justify-between pb-4 border-b border-app-border mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 id="interest-overview-title" className="text-lg font-bold text-app-text-bright">Perhitungan Bunga Rekening</h2>
            ...
            <button type="button"
              ...
              aria-label="Tutup perhitungan bunga"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 mb-6 bg-app-bg/50 p-3 rounded-2xl border border-app-border">
            <div className="flex items-center gap-2 flex-1">
              ...
              <select
                ...
                aria-label="Pilih rekening bunga"
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
            ...
            <div className="p-4 rounded-2xl bg-app-bg border border-app-border flex flex-col justify-between">
              <div>
                <p className="text-xs uppercase font-bold tracking-wider text-app-text/60 mb-1">
                  Bunga Hari Ini
                </p>
              ...
              <div className="mt-2 text-xs text-app-text/50 flex items-center gap-1">
